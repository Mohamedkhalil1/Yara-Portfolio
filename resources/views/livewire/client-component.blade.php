<div>
    ...
    {{--MODAL--}}
    <x-base.modal id="client" size="lg" formAction="updateOrCreate">
        <x-slot name="title">
            Service
        </x-slot>
        <x-slot name="content">
            <x-base.grid>
                ...
                <x-form.form-group col="8">
                    <x-form.input type="text" lazy class="round" name="client.title"/>
                </x-form.form-group>
                ...
                <x-form.form-group col="8">
                    <x-form.textarea wire:model="client.desc" title="Description ..."/>
                </x-form.form-group>
                ...
                <x-form.form-group col="8">
                    @if($client->image)
                        <x-base.avatar imageUrl="{{ getFile($client->image) }}"/>
                    @endif
